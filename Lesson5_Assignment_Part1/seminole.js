// Project Name: Seminole Trojans
// Program topics: Variables, Functions, Arrays, Loops
// Author: Jonathan Conley
// Date: October 1, 2015
...
function addGameInfo() {
  ...
  if (gameLocation[i] === "away"){
    ...
    //this statement will add the column headers to the page immediatelywhen the page loads in the browser